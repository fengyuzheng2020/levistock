...
def test_news_brief_yicai():
    ...
    print("\n\n[TEST 3] 验证数据结构...")
    try:
        data = news_brief_yicai(limit=1)
        if data:
            item = data[0]
            required_fields = ['id', 'title', 'content', 'time', 'share_url', 'important']
