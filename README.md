...
| 工具 | [get_trade_days](#get_trade_days) | 自有服务器 | 获取近N个交易日 |
...
```python
days = lk.get_trade_days()        # 近10个
days = lk.get_trade_days(n=5)     # 近5个
```
...
获取历史风向标列表，日期必须小于今天，字段同 `limit_up_his_kph()`。
