...
def main():
    ...
    # 检查是否至少开启一个功能
    if not enable_news and not enable_market and not enable_wind and not enable_yicai:
        print("[ERROR] 至少需要开启一个功能")
        print("[INFO] 请在 config.py 中设置 ENABLE_NEWS_MONITOR、ENABLE_MARKET_REPORT、ENABLE_MARKET_WIND 或 ENABLE_YICAI_MONITOR 为 True")
        sys.exit(1)
    ...
    # 统计开启的服务数量
    enabled_count = sum([enable_news, enable_market, enable_wind, enable_yicai])
